...
if (isset($_POST['send_message_btn'])) {
  ...
  $d1=$_POST['date1'];
  $i=0;
  $value="SELECT * from staff_reg where staff_reg.sid='$id1' and staff_reg.name='$name'";
  $v1=mysqli_query($con,$value);
  $res=mysqli_fetch_array($v1);
  if($res['sid']==$id1 and $res['name'==$name])
  {

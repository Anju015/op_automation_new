...
<!------ --->
	<div class="admin_body" style="margin-left: 20px;height: 600px;background-color: #442D96;overflow: hidden;">
		...
		<div class="tab" style="align-items: center;margin-left: 250px;">
				<a href="homepage.php">
						<b style="color: white;font-size: 22px;">HOME</b>
				</a> &nbsp;&nbsp;
               
				<a href="disp.php">
						<b style="color: white;font-size: 22px;">DISPENSE</b>
				</a> &nbsp;&nbsp;
				<div class="dropdown">
  					<button class="dropbtn"><b>MEDICINE</b></button>
  						<div class="dropdown-content">
    						<a href="medicine_add.php">ADD </a>
    						<a href="medicine_view.php">VIEW </a>
                            
    					</div>
				</div>
                <div class="dropdown">
  					<button class="dropbtn"><b>STOCK</b></button>
  						<div class="dropdown-content">
    						<a href="stock_view.php">VIEW </a>
    						<a href="expired_stock.php">EXPIRED </a>
        	...
        	<a href="category_add.php">
						<b style="color: white;font-size: 22px;">CATEGORY</b>
				</a> &nbsp;&nbsp;
               <a href="unit_add.php">
						<b style="color: white;font-size: 22px;">UNIT</b>
				</a> &nbsp;&nbsp;
               <a href="type_add.php">
						<b style="color: white;font-size: 22px;">TYPE</b>
				</a>&nbsp;&nbsp;
               
				<a href="logout.php">
					<b style="color: white;font-size: 22px;">
					LOGOUT
					</b>
				</a>
		</div>
		<div class="part1" style="margin-left: 250px; margin-top: 80px;background-image: url("images/b2.jpg");">
			...
			<div class="small_content" style="margin-left: 150px;">
				<p style="color:floralwhite;font-size: 25px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
			</div>
		</div>
	</div>

...
<?php
	...
	include('Dbconnection.php' );
     $today=date('Y-m-d');
	$result = mysqli_query($con,"SELECT medicine.*,stock.qty,stock.exp_date,stock.batch_no FROM medicine JOIN stock ON medicine.id=stock.medicine_id WHERE stock.exp_date < '$today' ");
?>

    ...
    <center>
     <div class="part1" style="width:800px;height:970px;margin-left: 270px;">
       <div class="modal-body" style="margin-top: 10px;">
        <h2 style="color: cornsilk;margin-top: 20px;">ADD TYPE</h4>
        <center>
             ...
             <tr>
               <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <td></td>
                <td>
                  <input class="form-control py-4"  type="text"  name="name" /></td>
              </tr>
          </div>
        </div>
      </div>
          <tr>
            <td></td>
            <td>
                <div class="form-group mt-4 mb-0"><button name="save" class="btn btn-primary btn-block" type="submit" style="width:80px;height:40px;">Save</button></div></td>
                <td>
    								<input type="reset" value="CLEAR" onClick=" ">
    						</td>
            <td><a href="pharmacy_home.php"  class="btn btn-primary" style="color:aliceblue;"><input type="button" value="BACK" style="width:80px;height:40px;"/></a> </td>

		 ...
		 <div class="part1" style="width:800px;height:970px;margin-left: 270px;">
			 ...
			 <div class="modal-body" style="margin-top: 10px;">
				<h2 style="color: cornsilk;margin-top: 20px;"></h4>
 				<center>
				 <table>
					<form action="edit_patient_query.php" method="POST" name="f1" enctype="multipart/form-data" class="form-donation">
            <div class="row">
								<tr>
								<div class="form-group col-md-12 ">
									<td>
										<h3  style="color: azure;">Patient Id &nbsp;&nbsp;&nbsp;</h3>  
									</td>
									<td>
                ...
                <div class="row">
                    <tr>
                        <center> <td>   <input type="submit" value="BACK" onClick="pageRedirect()"></td></center>
                    </tr>
                    </div>
            <tr></tr>

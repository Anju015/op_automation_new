		...
		<center>
		 <div class="part1" style="width:800px;height:970px;margin-left: 270px;">
			 ...
			 <div class="modal-body" style="margin-top: 10px;">
				<h2 style="color: cornsilk;margin-top: 20px;">PATIENT DETAILS</h4>
 				<center>
				 <table>
					<form action="patient_addquery.php" method="POST" name="f1" enctype="multipart/form-data" class="form-donation">
            <div class="row">
							<tr>

...
<?php
	...
	$sql = "SELECT * from patient_reg " . $queryCondition . " ORDER BY Date desc";
		 ...
		 <div class="part1" style="width:800px;height:970px;margin-left: 270px;">
            ...
            <div class="row">
							<tr>
							 ...
							 <tr>
                <td>
								 <input type="submit" value="BACK"  name="btnback"style="width:120px;"onClick="function1()"/>
                 <?php
						...
						<table class="table-content">
					      ...
					      <tr>
									  <th width="30%"><span>Name</span></th>
										<th width="30%"><span>Age</span></th>
						        <th width="50%"><span>Gender</span></th>
						        <th width="20%"><span>Address</span></th>
										<th width="30%"><span>Place</span></th>
										<th width="30%"><span>Admission Date</span></th>
						      </tr>
						     </thead>
						   <tbody>
						 <?php
						    ...
						    <tr>
									...
									<td style="color:white;"><?php echo $row["adress"]; ?></td>
									<td style="color:white;"><?php echo $row["place"]; ?></td>

...
<!------ --->
  <div class="admin_body" style="margin-left: 20px;height: 600px;background-color: #442D96;overflow: hidden;">
    <div class="tab" style="align-items: center;margin-left: 250px;">
      <a href="opstaff_home.php">
        <b style="color: white;font-size: 22px;">OP HOME</b>
      </a>
      <div class="dropdown">
        <button class="dropbtn"><b>PATIENT</b></button>
        <div class="dropdown-content">
          <a href="patient_admission.php">NEW REGISTRATION </a>
           <a href="opreg.php">DAILY OP </a>  
            <a href="op_list_view.php">OP LIST</a>     
                 
            <a href="edit_patient.php">UPDATE </a>
        </div>
      </div>
      <a href="../logout.php">

...
if(isset($_POST['save']))
{
  ...
  $pid=$_POST['txtid'];
	...
	$sql="INSERT INTO prescription_tabl  VALUES ('$presid','$pid','$name','$age','$desease','$medicine1','$dosage1','$usage1','$medicine2','$dosage2','$usage2','$medicine3','$dosage3','$usage3','$medicine4','$dosage4','$usage4','$medicine5','$dosage5','$usage5','$Othermedicine','$medusage','$status','$date')";
